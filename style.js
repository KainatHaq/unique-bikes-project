...
function orange() {
    color3.innerText = 'orange';
    color1.innerText = " ";
    color2.innerText = " ";
    
    // If you want to change the image's color to red, apply hue-rotate to adjust the image color
    image.style.filter = 'hue-rotate(190deg) saturate(5) brightness(0.7)';}
